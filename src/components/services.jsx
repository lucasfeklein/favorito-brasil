      ...
      <div className="container">
        ...
        <div className="recipe-container">
          ...
          <div className="recipe">
            ...
            <p>2- Colocar todos os restantes dos ingredientes a água e deixar misturar em baixa velocidade até homogeneizar bem.</p>
          ...
          <div className="recipe">
            ...
            <p>2- Colocar todos os demais ingredientes e misturar em baixa velocidade até homogeneizar bem.</p>
            <p>3- Deixar misturar em velocidade rápida até obter uma massa lisa e enxuta.</p>
            <p>4- Levar a massa para a mesa. Dividir em unidades de 550 gramas, modelar em bastões e colocar nas formas previamente preparada.</p>
            <p>5- Deixar em crescimento até atingir um centímetro antes da borda da forma, colocar e fazer o fechamento das formas e levar ao forno em temperatura média de 170 °c por cerca de 35 á 40 minutos.</p>
